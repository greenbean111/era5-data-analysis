...
def create_notebook():
    notebook_path = r"notebooks/Diurnal_Nocturnal_Wind_Roses.ipynb"
    ...
    cells = [
        {
            ...
            "metadata": {},
            "source": [
                "# ALMA Diurnal and Nocturnal Monthly Wind Roses\n",
                "\n",
                "This notebook generates monthly polar scatter wind rose plots for both years (2001 and 2002), splitting the data into:\n",
                "- **Diurnal**: 1 AM - 11 AM in UTC (Universal Time)\n",
                "- **Nocturnal**: 11 AM - 1 AM in UTC (Universal Time)\n",
                "\n",
                "We perform this analysis for two datasets:\n",
                "1. **Published Ground-Based Data**: Meteorological measurements from the ALMA weather station at Chajnantor Plateau.\n",
                "2. **ERA5 Reanalysis Data**: 10m wind components (`u10`, `v10`) at the grid point nearest to the ALMA coordinates."
            ]
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
                "## Part 1: ALMA Published Ground-Based Wind Roses"
            ]
        },
        {
            "cell_type": "code",
        ...
        },
        {
            ...
            "source": [
                "# ============================================================\n",
                "# HELPER: LOAD MET FILES WITH UTC HOUR\n",
                "# ============================================================\n",
        ...
        },
        {
            ...
            "source": [
                "# ============================================================\n",
                "# LOAD PUBLISHED DATA & COMPUTE GLOBAL VMAX\n",
                "# ============================================================\n",
        ...
        },
        {
            ...
            "source": [
                "# ============================================================\n",
                "# GENERATE SIDE-BY-SIDE PLOTS FOR PUBLISHED DATA\n",
                "# ============================================================\n",
        ...
        },
        {
            ...
            "metadata": {},
            "source": [
                "## Part 2: ERA5 Reanalysis Wind Roses"
            ]
        },
        {
            "cell_type": "code",
            ...
            "source": [
                "# ============================================================\n",
                "# LOAD ERA5 FILES & COMPUTE GLOBAL VMAX\n",
                "# ============================================================\n",
                "ALMA_LAT = -23.029\n",
                "ALMA_LON = -67.755\n",
                "\n",
                "chile_files = sorted(glob.glob(\"../data/raw/chile/chile_*.nc\"))\n",
                "print(f\"Found {len(chile_files)} ERA5 files.\")\n",
                "\n",
                "all_era5_speeds = []\n",
                "monthly_data_era5 = []\n",
                "\n",
        ...
        },
        {
            ...
            "source": [
                "# ============================================================\n",
                "# GENERATE SIDE-BY-SIDE PLOTS FOR ERA5 DATA\n",
                "# ============================================================\n",
        ...
        },
        {
            ...
            "metadata": {},
            "source": [
                "## Part 3: Combined Years (2001-2002) Wind Roses"
            ]
        },
        {
            "cell_type": "code",
            ...
            "source": [
                "# ============================================================\n",
                "# GENERATE COMBINED ROSES FOR ALL YEARS (PUBLISHED & ERA5)\n",
                "# ============================================================\n",
                "print(\"=== Processing Combined Datasets (All Years) ===\")\n",
                "\n",
